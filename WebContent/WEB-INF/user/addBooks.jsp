...
<body>
	<form class="layui-form" action="addbooks" style="margin-left: -40px;">
		...
		<div class="layui-form-item">
			...
			<div class="layui-input-inline">
				<input type="text" name="publishTime" required
					lay-verify="required|date" placeholder="请输入出版日期" autocomplete="off"
					class="layui-input" id="publishTime">
			</div>
		</div>
		...
		<div class="layui-form-item">
			...
			<div class="layui-input-inline">
				<input type="text" name="count" required
					lay-verify="required|number" placeholder="请输入该数的库存量"
